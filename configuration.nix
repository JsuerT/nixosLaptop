...
# on your system.  Help is available in the configuration.nix(5) 
# man page and in the NixOS manual (accessible by running 
# ‘nixos-help’).
...
{ imports =
 ...
 nix.settings.experimental-features = [ "nix-command" "flakes" ];
  ...
  i18n.extraLocaleSettings = { LC_ADDRESS = "de_DE.UTF-8"; 
    LC_IDENTIFICATION = "de_DE.UTF-8"; LC_MEASUREMENT = 
    "de_DE.UTF-8"; LC_MONETARY = "de_DE.UTF-8"; LC_NAME = 
    "de_DE.UTF-8"; LC_NUMERIC = "de_DE.UTF-8"; LC_PAPER = 
    "de_DE.UTF-8"; LC_TELEPHONE = "de_DE.UTF-8"; LC_TIME = 
    "de_DE.UTF-8";
  };
  ...
  services.pulseaudio.enable = false; security.rtkit.enable = 
  true; services.pipewire = {
  ...
  # desktopManager). services.xserver.libinput.enable = true;

  # Define a user account. Don't forget to set a password with 
  # ‘passwd’.
  users.users.ticco = { isNormalUser = true; description = 
    "ticco"; extraGroups = [ "networkmanager" "wheel" ]; packages 
    = with pkgs; [
    #  thunderbird
    ];
  };
...
git
    (vim-full.customize {
      ...
      # In der customRC ist es sauberer, Befehle untereinander zu schreiben
  ...
  # or are started in user sessions. programs.mtr.enable = true; 
